...
def create_question(question_text, days):
    """
    Create a question w/ given 'question_text' and published
    the given number of 'days' offset to now (negative
    for questions published in the past, positive
    for questions yet to be published)
    """
